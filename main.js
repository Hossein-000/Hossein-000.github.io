...
const portfolioItems = [
    { 
        ...
        // RENAMED: product-showcase.png
        image: 'assets/product-showcase.png', 
    ...
    { 
        ...
        // RENAMED: engine-wireframe.jpg & engine-render.jpg
        beforeImage: 'assets/engine-wireframe.jpg',
        afterImage: 'assets/engine-render.jpg',
    ...
    { 
        ...
        // RENAMED: ac-animation.mp4
        videoSrc: 'assets/ac-animation.mp4', 
   ...
   // }, 
    { 
        ...
        image: 'assets/product-viz-1.png', 
        gradient: 'from-lime-900 to-emerald-900', icon: 'fas fa-box', iconColor: 'text-lime-300', 
        description: "Photorealistic product visualization for a commercial client. Focused on studio lighting and material accuracy.", 
        tags: ["Blender", "AI"] 
    },
    { 
        type: 'image', title: 'Product Viz', category: 'Realistic Rendering', aspect: 'aspect-square', 
        // RENAMED: product-viz-2.jpg
        image: 'assets/product-viz-2.jpg', 
        gradient: 'from-teal-900 to-green-900', icon: 'fas fa-dice-d20', iconColor: 'text-teal-300', 
        description: "helping someone having his pot eternally", 
        tags: ["Blender"] 
    },
    { 
        type: 'image', title: 'Product Viz', category: 'Rendering', aspect: 'aspect-[3/4]', 
        // RENAMED: product-viz-3.png
        image: 'assets/product-viz-3.png', 
        gradient: 'from-green-950 to-emerald-950', icon: 'fas fa-dragon', iconColor: 'text-green-400', 
        description: "Product advertisment design", 
        tags: ["Blender", "AI"] 
    },
    { 
        type: 'video', title: 'Announcment', category: 'Animation', duration: '1:34', aspect: 'aspect-video', 
        // RENAMED: announcement.mp4 (Note lowercase 'a')
        videoSrc: 'assets/announcement.mp4', 
        description: "the announcement motiongraphic for hackathon at Sharif University", 
        tags: ["After Effects" , "Illustrator"] 
    },
    { 
        type: 'image', title: 'Product viz', category: 'Modeling', aspect: 'aspect-square', 
        // RENAMED: product-viz-4.png
        image: 'assets/product-viz-4.png', 
        gradient: 'from-stone-900 to-emerald-950', icon: 'fas fa-robot', iconColor: 'text-stone-400', 
        description: "Mixing AI with 3D modeling to reach higher heights", 
        tags: ["Blender", "AI"] 
    },
    { 
        type: 'image', title: 'Product viz', category: 'Modeling', aspect: 'aspect-square', 
        // RENAMED: product-viz-5.png
        image: 'assets/product-viz-5.png', 
        gradient: 'from-stone-900 to-emerald-950', icon: 'fas fa-robot', iconColor: 'text-stone-400', 
        description: "Grabbing AI tools to help and make a better cloth!", 
        tags: ["Blender", "AI"] 
    },
    { 
        type: 'image', title: 'Product viz', category: 'Modeling', aspect: 'aspect-square', 
        // RENAMED: sunscreen.jpg
        image: 'assets/sunscreen.jpg', 
        gradient: 'from-stone-900 to-emerald-950', icon: 'fas fa-robot', iconColor: 'text-stone-400', 
        description: "3D modeling of SunScreens", 
        tags: ["Blender"] 
    },
    { 
        type: 'image', title: 'Product viz', category: 'Modeling', aspect: 'aspect-square', 
        // RENAMED: eye-care.jpg
        image: 'assets/eye-care.jpg', 
        gradient: 'from-stone-900 to-emerald-950', icon: 'fas fa-robot', iconColor: 'text-stone-400', 
        description: "showcasing an eye care product by mixing 3D modeling and AI", 
        tags: ["Blender", "AI"] 
    }
];
